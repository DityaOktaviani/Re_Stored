...
<div class="modal fade" id="addModal" tabindex="-1" role="dialog" aria-labelledby="addModalLabel" aria-hidden="true">
  ...
  <div class="modal fade" id="viewModal" tabindex="-1" role="dialog" aria-labelledby="viewModalLabel" aria-hidden="true">
    <div class="modal-dialog" role="document">
      <div class="modal-content">
        <div class="modal-header">
          <h5 class="modal-title" id="addModalLabel">Lihat Data Mahasiwa</h5>
          <button type="button" class="close" data-dismiss="modal" aria-label="Close">
            <span aria-hidden="true">&times;</span>
          </button>
        </div>
        ...
        <div class="row">
          <div class="col-12">
            ...
            <div class="card card-primary">
              ...
              <?php echo "kalo ada catatan silakan isi"?>
              </div>
              <!-- /.card-footer-->
            </div>
            <!-- /.card -->
    ...
    $.ajax({
      ...
      success:function (response){
        ...
        $.each(response.anggota, function(key, val){
          ...
          $('.view_nim').text(val['username']);
          $('.view_nama').text(val['nama']); 
        });
      }
    });
  });
  ...
  Swal.fire({
    ...
    if (result.isConfirmed) {
      $.ajax({
        ...
        success:function (response){
          //console.log(response.anggota);
          Swal.fire('Data berhasil dihapus!!', '', 'Berhasil')
          $('.datamhs').html("");
          loaddata();
        }
      });
